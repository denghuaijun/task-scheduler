...
/**
 * @ Author     ：libin
 * @ Date       ：Created in 19:04 2018/9/6
 * @ Description：运行器 controller
 * @ Modified By：
 * @Version:
 */
@Controller
public class TaskrunnerCotroller {
    ...
    public ReturnDTO<String> taskrunnerAdd(TaskRunnerDTO taskRunnerDTO) {
        return taskrunService.taskrunnerAdd(taskRunnerDTO);
    }
    ...
    public ReturnDTO<String> taskrunnerDelete(TaskRunnerDTO taskRunnerDTO) {
        ...
        return taskrunService.taskrunnerModify(taskRunnerDTO);
    }
    ...
    public Map<String, Object> pageList(@RequestParam(required = false, defaultValue = "0") int start,
        ...
        return taskrunService.pageList(start, length);
    }
}
