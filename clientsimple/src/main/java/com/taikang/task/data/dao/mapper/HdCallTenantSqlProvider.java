...
import com.taikang.task.data.dao.entity.HdCallTenantExample.Criteria;
import com.taikang.task.data.dao.entity.HdCallTenantExample.Criterion;

import java.util.List;
import java.util.Map;

public class HdCallTenantSqlProvider {

    public String countByExample(HdCallTenantExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("hd_call_tenant");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(HdCallTenantExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("hd_call_tenant");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(HdCallTenantWithBLOBs record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("hd_call_tenant");
    ...
    public String selectByExampleWithBLOBs(HdCallTenantExample example) {
        SQL sql = new SQL();
    ...
    public String selectByExample(HdCallTenantExample example) {
        SQL sql = new SQL();
        if (example != null && example.isDistinct()) {
            sql.SELECT_DISTINCT("id");
        } else {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        HdCallTenantWithBLOBs record = (HdCallTenantWithBLOBs) parameter.get("record");
        HdCallTenantExample example = (HdCallTenantExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("hd_call_tenant");
    ...
    public String updateByPrimaryKeySelective(HdCallTenantWithBLOBs record) {
        SQL sql = new SQL();
        sql.UPDATE("hd_call_tenant");
    ...
    protected void applyWhere(SQL sql, HdCallTenantExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
